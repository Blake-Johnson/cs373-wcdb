...
DATABASES = {
    'default': {
        ...
        'NAME': 'cs373_astacy',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'astacy',
        'PASSWORD': '5ZSeqwT84W',
        'HOST': 'z',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
SECRET_KEY = 'x-w4-b0t+i7tyc#%f7o(!ji-d8l-1qc3=#erdw%r5rt!u0d-vl'
